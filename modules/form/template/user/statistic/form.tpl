...
<table>
  <tr>
    ...
    <td class="cell-center">
      ...
      <span class="p14"> <i> Đắk Lắk, ngày {noticetime_0} tháng {noticetime_1} năm {noticetime_2} </i> </span> 
    </td>
  </tr>
</table>
...
<!-- {info} {owner}  -->
<p class="p14"> &emsp;&emsp; Loài động vật được lấy mẫu: {sample}</p>
<p class="p14"> &emsp;&emsp; Loại mẫu: {sampletype}</p> 
<p style="clear: left; width: 60%; float: left;" class="p14"> &emsp;&emsp; Số lượng mẫu: {numberword} </p> 
...
<p class="p14"> <i> &emsp;&emsp;(Chi tiết xem phiếu kết quả xét nghiệm số: {xcode_0}/{xcode_1}/{xcode_2}.CĐXN của trạm chẩn đoán xét nghiệm bệnh động vật)./. </i></p>
...
<div style="width: 40%; float: left;" class="text-center p14">
  <b> {xsigner} <span class="xsign"></span><br style="clear: both;"> {receiveleader} </b>
</div>
<!-- END: main -->
